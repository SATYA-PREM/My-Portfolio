    ...
    <section id="contact">
      <div className="contact-card">
        ...
        <p className="contact-desc">
          I am actively seeking software engineering roles, backend development opportunities, and full-stack projects. Feel free to connect!
        </p>
        ...
        <div className="contact-ctas">
          <a
            ...
            className="btn-primary email-trigger"
            title="Send email"
          >
            <svg
              width="14"
